...
CREATE TABLE `likes`  (
  ...
  `liked_id` int NULL DEFAULT NULL COMMENT '来自于评论或者动态的id',
...
CREATE TABLE `tweet`  (
  ...
  `url` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图像、语音、视频',
