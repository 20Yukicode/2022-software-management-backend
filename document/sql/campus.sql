...
CREATE TABLE `chat_record`  (
  ...
  `send_user_id` int(0) NULL DEFAULT NULL COMMENT '发送者Id',
  `receive_user_id` int(0) NULL DEFAULT NULL COMMENT '接收者Id',
  `content` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '内容',
  `is_read` int(0) NULL DEFAULT NULL COMMENT '0-未读，1-已读',
...
CREATE TABLE `comment`  (
  ...
  `p_tweet_id` int(0) NULL DEFAULT NULL COMMENT '父节点是动态',
  `p_comment_id` int(0) NULL DEFAULT NULL COMMENT '父节点是评论',
  `content` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '内容',
...
CREATE TABLE `criteria`  (
  ...
  `gender` int(0) NULL DEFAULT NULL COMMENT '对象性别（0-异性，1-同性，2-都可以）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `likes`  (
  ...
  `like_id` int(0) NULL DEFAULT NULL COMMENT '来自于评论或者动态的id',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '点赞者',
  `is_tweet` int(0) NULL DEFAULT NULL COMMENT '是否是动态1-tweet 0-comment',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `notice`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `message_id` int(0) NULL DEFAULT NULL COMMENT '消息Id',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '接收消息用户Id',
  `message_type` int(0) NULL DEFAULT NULL COMMENT '0-关注，1-点赞，2-评论，3-系统通知',
  `is_read` int(0) NULL DEFAULT NULL COMMENT '是否被阅读（0-读过，1-没读过）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `report`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '举报Id',
  ...
  `reported_id` int(0) NULL DEFAULT NULL COMMENT '举报者id',
  `reported_type` int(0) NULL DEFAULT NULL COMMENT '被举报内容的类型',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `subscribed`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `is_subscibed` int(0) NULL DEFAULT NULL COMMENT '是否关注',
  `first_user_id` int(0) NULL DEFAULT NULL COMMENT '关注者A',
  `second_user_id` int(0) NULL DEFAULT NULL COMMENT '关注者B',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `topic`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '话题Id',
  `heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '标题',
  `participants` int(0) NULL DEFAULT NULL COMMENT '参与人数',
  `tweet_num` int(0) NULL DEFAULT NULL COMMENT '动态数量',
...
CREATE TABLE `tweet`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '动态Id',
  `like_num` int(0) NULL DEFAULT NULL COMMENT '喜欢数',
  `read_num` int(0) NULL DEFAULT NULL COMMENT '阅读量',
...
CREATE TABLE `user`  (
  ...
  `state` int(0) NULL DEFAULT NULL COMMENT '0-单身\r\n0单身，1-恋爱',
